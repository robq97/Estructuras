...
public class EliminarVuelo extends javax.swing.JFrame {
    ...
    public EliminarVuelo() throws ParseException {
        initComponents();
        setTitle("Eliminar Vuelo Público");                                     //Titulo, fondo, redimensionable y ubicacion de la ventana.
    ...
    private void btnReservarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReservarActionPerformed
        ...
        if (idVuelo.length() <= 0){                                             //Obliga al admin a darle clic a cualquier vuelo.
            ...
            try {
                ...
                tblVuelos.setModel(handler.modeloPub());                        //Se ingresa el modelo de tabla con los datos de los vuelos publicos actualizada.
                txtId.setText("");
